...
export const CSS_CONFIG: CSSSection[] = [
	{
		...
		properties: [
			...
			{ name: 'opacity', value: 1, type: 'slider', unit: '', min: 0, max: 1, step: 0.1 }
		]
	},
	{
		section: 'border',
		...
		properties: [
			{ name: 'borderWidth', value: '2px', type: 'slider', unit: 'px', min: 0, max: 20 },
			{ name: 'borderStyle', value: 'solid', type: 'select', options: ['none', 'solid', 'dashed', 'dotted', 'double'] },
			{ name: 'borderColor', value: '#2c3e50', type: 'color' },
			{ name: 'borderTopLeftRadius', value: '8px', type: 'slider', unit: 'px', min: 0, max: 100 },
			{ name: 'borderTopRightRadius', value: '8px', type: 'slider', unit: 'px', min: 0, max: 100 },
			{ name: 'borderBottomLeftRadius', value: '8px', type: 'slider', unit: 'px', min: 0, max: 100 },
			{ name: 'borderBottomRightRadius', value: '8px', type: 'slider', unit: 'px', min: 0, max: 100 }
		]
	},
	{
		section: 'boxShadow',
		...
		properties: [
			{ name: 'boxShadowX', value: '0px', type: 'slider', unit: 'px', min: -50, max: 50 },
			{ name: 'boxShadowY', value: '4px', type: 'slider', unit: 'px', min: -50, max: 50 },
			{ name: 'boxShadowBlur', value: '10px', type: 'slider', unit: 'px', min: 0, max: 100 },
			{ name: 'boxShadowSpread', value: '0px', type: 'slider', unit: 'px', min: -50, max: 50 },
	...
	},
	{
		...
		properties: [
			...
			{ name: 'fontSize', value: '16px', type: 'slider', unit: 'px', min: 8, max: 72 },
			{ name: 'fontWeight', value: '400', type: 'select', options: ['100', '200', '300', '400', '500', '600', '700', '800', '900'] },
			{ name: 'color', value: '#333333', type: 'color' },
			{ name: 'letterSpacing', value: '0px', type: 'slider', unit: 'px', min: -5, max: 10 },
			{ name: 'lineHeight', value: '1.5', type: 'slider', min: 1, max: 3, step: 0.1 },
	...
	},
	{
		...
		properties: [
			{ name: 'rotate', value: '0deg', type: 'slider', unit: 'deg', min: 0, max: 360 },
			{ name: 'scale', value: '1', type: 'slider', min: 0.1, max: 3, step: 0.1 },
			{ name: 'skewX', value: '0deg', type: 'slider', unit: 'deg', min: -45, max: 45 },
			{ name: 'skewY', value: '0deg', type: 'slider', unit: 'deg', min: -45, max: 45 },
			{ name: 'translateX', value: '0px', type: 'slider', unit: 'px', min: -200, max: 200 },
			{ name: 'translateY', value: '0px', type: 'slider', unit: 'px', min: -200, max: 200 }
		]
	},
	{
		section: 'filter',
		...
		properties: [
			{ name: 'blur', value: '0px', type: 'slider', unit: 'px', min: 0, max: 20 },
			{ name: 'brightness', value: '100%', type: 'slider', unit: '%', min: 0, max: 200 },
			{ name: 'contrast', value: '100%', type: 'slider', unit: '%', min: 0, max: 200 },
			{ name: 'grayscale', value: '0%', type: 'slider', unit: '%', min: 0, max: 100 },
			{ name: 'saturate', value: '100%', type: 'slider', unit: '%', min: 0, max: 200 },
			{ name: 'sepia', value: '0%', type: 'slider', unit: '%', min: 0, max: 100 }
		]
	},
	{
		section: 'transition',
